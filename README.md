...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/trirus-hyperai)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/trirus-hyperai
```

A live public deployment of this template is available at [https://trirus-hyperai.templates.workers.dev](https://trirus-hyperai.templates.workers.dev)
